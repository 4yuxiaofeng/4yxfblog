...
func (this *ArticleController) Add() {
	this.Data["posttime"] = this.getTime().Format("2018-03-22 15:04:05")
	this.display()
}
...
func (this *ArticleController) Edit() {
	...
	this.Data["post"] = post
	this.Data["posttime"] = post.PostTime.Format("2018-03-22 15:04:05")
	this.display()
}
...
func (this *ArticleController) Save() {
	...
	if id < 1 {
		...
		post.PostTime = this.getTime().Local()
		post.UpdateTime = this.getTime().Local()
		post.Insert()
	} else {
		post.Id = id
		if post.Read() != nil {
